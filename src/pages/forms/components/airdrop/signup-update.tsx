...
export const SignUpUpdate = (props: SignUpUpdateProps) => {
  ...
  const onSignUpUpdate = (e: any) => {
    ...
    //@ts-expect-error This error is expected because the 'current' property is missing in type 'MutableRefObject<unknown>'.
    ...
    <div className="flex flex-col gap-2 w-full text-white">
      ...
      <form className="">
        ...
        <div className="relative">
          ...
          <div className="w-full flex flex-col lg:flex-row gap-1 lg:gap-2">
            ...
            <div className="flex flex-row gap-1 self-center w-full lg:w-auto">
              <ExampleModal />
              <a
                href="https://drive.google.com/drive/folders/1ee5VmlfZqk-68-5fVePAtBHpQhKJ0GKz?usp=drive_link"
                target="_blank"
        ...
        >
          ...
          will be distributed among {props.dropInfo.numberOfMaxAirdropUsers}{" "}
          people equaly.
        </p>
      </form>
    </div>
